  ...
  <div class="md:items-end my-10 flex flex-col md:flex-row gap-1" data-search>
    ...
    <div class="grid grid-rows-1 gap-2">
      ...
      <div class="flex items-center">
        <input class="w-full border border-gray-400 px-5 py-1 text-gray-900" data-start type="date" />
        <span class="mx-2">to</span>
        <input class="w-full border border-gray-400 px-5 py-1 text-gray-900" data-end type="date" />
      </div>
    </div>
