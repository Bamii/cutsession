...
const template = `
  <div data-signup>
    <div class="flex flex-col">
      ...
      <input class="my-5 py-2 px-6 border text-gray-400" type="date" id="" data-dob placeholder="enter your dob">
      ...
      <input class="my-5 py-2 px-6 border text-gray-400" type="text" id="" data-cityofresidence placeholder="enter your city of residence">
